				 ...
				 struct snd_soc_dai *dai)
{
	...
	return mtk_dai_i2s_config(afe, params, dai_id);
}
				  ...
				  int clk_id, unsigned int freq, int dir)
{
	...
	if (dai_id >= MT8196_DAI_NUM || dai_id < 0 || dir != SND_SOC_CLOCK_OUT)
		return -EINVAL;
...
static int mtk_dai_i2s_set_fmt(struct snd_soc_dai *dai, unsigned int fmt)
{
	...
	if (dai_id >= MT8196_DAI_NUM || dai_id < 0)
		return -EINVAL;

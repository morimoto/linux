...
static int avs_da7219_probe(struct platform_device *pdev)
{
	...
	if (pdata->obsolete_card_names) {
		snd_soc_card_set_name(card, "avs_da7219");
	} else {
		card_driver->driver_name = "avs_da7219";
		snd_soc_card_set_name(card, "AVS I2S DA7219");
		snd_soc_card_set_long_name(card, "AVS I2S DA7219");
	}

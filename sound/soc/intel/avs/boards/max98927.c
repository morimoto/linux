...
static int avs_max98927_probe(struct platform_device *pdev)
{
	...
	if (pdata->obsolete_card_names) {
		snd_soc_card_set_name(card, "avs_max98927");
	} else {
		card_driver->driver_name = "avs_max98927";
		snd_soc_card_set_name(card, "AVS I2S MAX98927");
		snd_soc_card_set_long_name(card, "AVS I2S MAX98927");
	}

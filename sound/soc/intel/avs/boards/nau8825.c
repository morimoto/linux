...
static int avs_nau8825_probe(struct platform_device *pdev)
{
	...
	if (pdata->obsolete_card_names) {
		snd_soc_card_set_name(card, "avs_nau8825");
	} else {
		card_driver->driver_name = "avs_nau8825";
		snd_soc_card_set_name(card, "AVS I2S NAU8825");
		snd_soc_card_set_long_name(card, "AVS I2S NAU8825");
	}

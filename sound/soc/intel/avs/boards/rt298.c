...
static int avs_rt298_probe(struct platform_device *pdev)
{
	...
	if (pdata->obsolete_card_names) {
		snd_soc_card_set_name(card, "avs_rt298");
	} else {
		card_driver->driver_name = "avs_rt298";
		snd_soc_card_set_name(card, "AVS I2S ALC298");
		snd_soc_card_set_long_name(card, "AVS I2S ALC298");
	}

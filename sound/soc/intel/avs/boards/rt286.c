...
static int avs_rt286_probe(struct platform_device *pdev)
{
	...
	if (pdata->obsolete_card_names) {
		snd_soc_card_set_name(card, "avs_rt286");
	} else {
		card_driver->driver_name = "avs_rt286";
		snd_soc_card_set_name(card, "AVS I2S ALC286");
		snd_soc_card_set_long_name(card, "AVS I2S ALC286");
	}

...
static struct snd_soc_card_driver sof_audio_card_cs42l42 = {
	.default_name = "cs42l42", /* the sof- prefix is added by the core */
	.owner = THIS_MODULE,
...
static int sof_audio_probe(struct platform_device *pdev)
{
	...
	return devm_snd_soc_card_register(card, &sof_audio_card_cs42l42);
}
